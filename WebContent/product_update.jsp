...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="container">
		<div class="card card-login mx-auto mt-5">
			...
			<div class="card-body">
				<form method="post" action="product_updateAction.jsp">
				<%
				try {
					stmt = db_con.stmt();
				...
				%>
					...
					<div class="form-group">
						<label for="exampleInputPassword1">상품명</label> <input
							class="form-control" name="product_name" type="text"
							value=<%=rs.getString(2)%>>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">규격</label> <input
							class="form-control" name="product_size" type="text"
							value=<%=rs.getString(3)%>>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">재고</label> <input
							class="form-control" name="product_stock" type="text"
