...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="container">
		<div class="card card-login mx-auto mt-5">
			...
			<div class="card-body">
				<form method="post" action="salePlace_updateAction.jsp">
				<%
				try {
					stmt = db_con.stmt();
				...
				%>
					...
					<div class="form-group">
						<label for="exampleInputPassword1">판매처연락처</label> <input
							class="form-control" name="seller_phone" type="text"
							value=<%=rs.getString(2)%>>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">판매처주소</label> <input
							class="form-control" name="seller_address" type="text"
							value=<%=rs.getString(3)%>>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">미수금액</label> <input
							class="form-control" name="Receivable" type="text"
