...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="container">
		<div class="card card-login mx-auto mt-5">
			...
			<div class="card-body">
				<form method="post" action="purchase_updateAction.jsp">
				<%
				try {
					stmt = db_con.stmt();
				...
				%>
					<div class="form-group">
						<input type = "hidden"
							class="form-control" name="buy_no" type="text"
							value=<%=rs.getString(1)%>>
					</div>
					<div class="form-group">
						<input type = "hidden"
							class="form-control" name="buy_date" type="text"
							value=<%=rs.getString(2)%>>
					</div>
					<div class="form-group">
								 <label for="exampleInputEmail1">구매처이름</label>
								 <div>
									<select name="buyer_name" class="select-picker">
					...
					<div class="form-group">
						<label for="exampleInputPassword1">구매수단</label> <input
							class="form-control" name="buy_way" type="text"
							value=<%=rs.getString(5)%>>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">구매합계</label> <input
							class="form-control" name="buy_sum" type="text"
