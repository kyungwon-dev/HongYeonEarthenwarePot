...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="container">
		<div class="card card-login mx-auto mt-5">
			...
			<div class="card-body">
				<form method="post" action="purchaselist_updateAction.jsp">
				<%
				try {
					stmt = db_con.stmt();
				...
				%>
					<div class="form-group">
						<input type="hidden" class="form-control" name="buy_no"
					...
					<div class="form-group">
						<input type="hidden" class="form-control" name="product_no"
							type="text" value=<%=rs.getString(3)%>>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">구매수량</label> <input
							class="form-control" name="buy_amount" type="text"
							value=<%=rs.getString(4)%>>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">구매매입가</label> <input
							class="form-control" name="buy_price" type="text"
