...
<%
	...
	String size  = request.getParameter("Input_size");
	String stock = request.getParameter("Input_stock");
	...
	try {
		...
		String sql = "insert into product VALUES('"+no+"','"+name+"','"+size+"','"+stock+"')"; // sql 쿼리
