...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="container">
		<div class="card card-login mx-auto mt-5">
			...
			<div class="card-body">
				<form method="post" action="selllist_updateAction.jsp">
				<%
				try {
					stmt = db_con.stmt();
				...
				%>
					...
					<div class="form-group">
						<label for="exampleInputPassword1">판매수량</label> <input
							class="form-control" name="sell_amount" type="text"
							value=<%=rs.getString(4)%>>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">단가</label> <input
							class="form-control" name="sell_price" type="text"
